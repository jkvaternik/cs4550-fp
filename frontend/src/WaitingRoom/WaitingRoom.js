  ...
  if (state.playlist_name) {
    body = (
      ...
      <div className="setup">
        ...
        <p>The playlist that is generated will be a specially crafted assortment of songs for you and your friends based on your collective favorite artists, songs, and genres. As a group, you can choose up to 3 genres for your playlist. Cast your votes below, then click "Ready!" when you are done making changes.</p>
    ...
    body = (
      <>
        <h2 style={{ margin: "2.0rem 0" }}>Create Your Playlist!</h2>
        <p>Enter the name of your playlist below. <br></br> You will then be given a link to share with your friends!</p>
        <input
          type="text"
          value={playlist}
